    ...
    <>
      ...
      <section className="section" style={{ background: "#fff", padding: "100px 0" }}>
        <div className="container">
          <div style={{ marginBottom: 64 }}>
            <p className="label" style={{ color: "var(--gold)", marginBottom: 16 }}>Member companies</p>
            ...
            {[
              ...
              >
                ...
                {c.url ? (
                  ...
                  <Link href="/en/ecosystem" style={{ fontSize: 13, color: "var(--gold)", fontWeight: 500, textDecoration: "none" }}>
                    View products →
                  </Link>
                )}
              </div>
      ...
      <section className="section" style={{ background: "#fff", padding: "100px 0" }}>
        <div className="container">
          <div style={{ textAlign: "center", marginBottom: 56 }}>
            <p className="label" style={{ color: "var(--gold)", marginBottom: 12 }}>Leadership</p>
          ...
          <div style={{ maxWidth: 760, margin: "0 auto" }}>
            <div className="leadership-card" style={{ display: "grid", gridTemplateColumns: "280px 1fr", border: "1px solid var(--border)", overflow: "hidden" }}>
              ...
              <div style={{ padding: "40px 40px", display: "flex", flexDirection: "column", justifyContent: "center", background: "#FAFAF8" }}>
                ...
                <p style={{ fontSize: 13, color: "var(--gold)", letterSpacing: "0.08em", textTransform: "uppercase", marginBottom: 24 }}>Chairman of the Board</p>
                ...
                <p style={{ fontSize: 14, color: "var(--text-secondary)", lineHeight: 1.75, marginBottom: 32 }}>
                  Founder and leader of A&D Group with over 10 years of experience in corporate law, M&A and LegalTech ecosystem development in Vietnam.
                </p>
                <Link href="/en/leadership" style={{ display: "inline-flex", alignItems: "center", gap: 8, fontSize: 13, color: "var(--gold)", textDecoration: "none", fontWeight: 500, letterSpacing: "0.04em" }}>
      ...
      <section style={{ position: "relative", padding: "120px 0", overflow: "hidden" }}>
        ...
        <div className="container" style={{ position: "relative", textAlign: "center" }}>
          <p className="label" style={{ color: "var(--gold)", marginBottom: 20 }}>Start collaborating</p>
          <h2 className="font-display" style={{ fontSize: "clamp(32px, 4.5vw, 60px)", fontWeight: 500, color: "#F7F3ED", lineHeight: 1.15, maxWidth: 640, margin: "0 auto 20px" }}>
            Ready to partner with your business
          </h2>
          <p style={{ color: "rgba(247,243,237,0.55)", fontSize: 16, maxWidth: 480, margin: "0 auto 48px", lineHeight: 1.7 }}>
            Legal, accounting, technology — comprehensive solutions for your business.
          </p>
          <Link href="/en/contact" style={{
