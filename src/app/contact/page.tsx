    ...
    <>
      ...
      <div style={{ height: 380, borderTop: "1px solid var(--border)", overflow: "hidden" }}>
        <iframe
          ...
          title="A&D Group — 520 Cách Mạng Tháng Tám, TP. Hồ Chí Minh"
        />
      </div>
    </>
  );
